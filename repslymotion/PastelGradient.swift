...
@objc public enum PastelGradient: Int {
    ...
    func colors() -> [UIColor] {
        ...
        case .ok:
            return[(#colorLiteral(red: 0.5647058824, green: 0.9215686275, blue: 0.8196078431, alpha: 0.9034674658)),(#colorLiteral(red: 0.5048072073, green: 0.9204463363, blue: 0.8187273145, alpha: 1)),(#colorLiteral(red: 0.3384783003, green: 0.919265449, blue: 0.7658109598, alpha: 1))]
        case .pleaseRefresh:
            return [#colorLiteral(red: 1, green: 0.1491314173, blue: 0, alpha: 1), #colorLiteral(red: 1, green: 0.3728841146, blue: 0, alpha: 0.8842840325)]
        }
    }
}
